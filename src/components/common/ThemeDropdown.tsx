      ...
      >
        <div className="shrink-0 flex items-center justify-center">
          {themeMode === 'light' ? (
            ...
            <Monitor className="w-3 h-3 stroke-[2]" />
          )}
        </div>
        {showLabel && (
          <span
      ...
      <AnimatePresence>
        {open && (
          <motion.ul
            ...
            } top-full mt-1.5 w-44 sm:w-48 bg-white dark:bg-[#120726] border border-slate-200 dark:border-purple-400/40 rounded-xl shadow-2xl dark:shadow-[0_0_25px_rgba(147,51,234,0.25)] p-1.5 z-50 backdrop-blur-md list-none space-y-0.5`}
            role="menu"
            aria-orientation="vertical"
          >
            <li className="px-2 py-1 border-b border-slate-100 dark:border-purple-800/40 mb-0.5 flex items-center justify-between">
              <span className="text-[11px] font-bold text-slate-900 dark:text-purple-100">
                Theme Preference
              </span>
              <span className="text-[9px] font-semibold text-purple-600 dark:text-purple-200 bg-purple-50 dark:bg-purple-500/20 px-1.5 py-0.5 rounded-full border border-purple-200 dark:border-purple-400/40 capitalize">
                {themeMode}
              </span>
            </li>
            ...
            <li role="none">
              <button
                ...
                className={`w-full flex items-center justify-between px-2 py-1 text-xs font-medium transition cursor-pointer rounded-lg ${
                  themeMode === 'light'
              ...
              >
                <div className="flex items-center gap-2 min-w-0">
                  ...
                  <span className="truncate text-[11px]">Light</span>
                </div>
                {themeMode === 'light' && (
            ...
            <li role="none">
              ...
              >
                <div className="flex items-center gap-2 min-w-0">
                  ...
                  <span className="truncate text-[11px]">Dark</span>
                </div>
                {themeMode === 'dark' && (
                  <Check className="w-3 h-3 text-white stroke-[2.5] shrink-0" />
                )}
            ...
            <li role="none">
              ...
              >
                <div className="flex items-center gap-2 min-w-0">
                  ...
                  <span className="truncate text-[11px]">System</span>
                </div>
